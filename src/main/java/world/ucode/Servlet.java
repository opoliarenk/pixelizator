...
public class Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String pixSize = req.getHeader("pix_size");
...
//    private void pixelizatingImageTriangle(Raster src, WritableRaster dest, int pixSize) {
//        int k = 0;
//        for (int y = 0; y < src.getHeight(); y += pixSize) {
//            for (int x = 0; x < src.getWidth(); x += pixSize) {
//                src.getPixel(x, y, pixel);
//                for (int yd = y; (yd < y + pixSize) && (yd < dest.getHeight()); yd++) {
//                    for (int xd = x; (xd < x + pixSize - k) && (xd < dest.getWidth()); xd++) {
//                        dest.setPixel(xd, yd, pixel);
//                    }
//                    k++;
//                }
////                src.getPixel(x, y, pixel);
//                for (int yd = y + pixSize; (yd > pixSize - y); yd--) {
//                    for (int xd = x + 1; (xd < x + pixSize - 1); xd++) {
//                        dest.setPixel(xd, yd, pixel);
//                    }
//                }
//                k = 0;
